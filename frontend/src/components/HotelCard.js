...
const HotelCard = ({ hotel }) => {
    return (
        <div className="flex flex-col md:flex-row md:min-h-60 gap-8 bg-blue-300 rounded-md my-4 md:items-center rounded-[50px]">
            ...
            <div className="md:w-4/6 mx-4 md:my-6 mb-6">
                ...
                <div className="flex gap-4 flex-wrap mt-6">
                    {hotel.specification?.map((spec) => (
                        <div key={spec} className="py-2 px-3 bg-gray-100 rounded-[50px]">
