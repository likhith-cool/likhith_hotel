        ...
        <Fragment>
            ...
            <Fragment>
                {isLoading ? <Loader /> : (
                    <Fragment>
                        {!room ? <NotFound /> : (
                            <div className="mx-auto px-4 md:px-10 lg:px-20 xl:px-48  flex flex-col md:flex-row  md:justify-between bg-pink-200 ">
                                ...
                                <div className="flex flex-col items-center">
                                    <div className="px-1 sm:px-3">
                                        ...
                                        <div className="ml-8 flex mb-4">
                                            ...
                                            <button onClick={() => setIsDateOpen(!isDateOpen)}>
                                                <textarea value={dates?.toString()} disabled={true} id="phone" rows={dates.length + 1} cols={10} className="py-2 px-1 sm:px-2 rounded-md border border-solid border-gray-400 text-gray-700 font-mono cursor-pointer break-all resize-none hover:bg-blue-200 transition duration-200" />
                                            </button>
                                    ...
                                    <div className="px-1 sm:px-3 py-20 flex justify-center sm:justify-end items-center ">
                                        <button onClick={onCheckout} className="py-4 w-60 block text-center rounded-lg bg-blue-500 hover:bg-gray-100 hover:text-blue-500 transition duration-200 text-zinc-50 " disabled={willCheckOut ? false : true} >Checkout</button>
                                    </div>
                                </div>
                            </div >
                        )}
