    ...
    return (
        ...
        <Fragment>
            {isLoading ? <Loader /> : (
                <Fragment>
                    {!hotel ? <NotFound /> : (
                        <div className="flex flex-col md:min-h-60 gap-8 bg-pink-100  pt-4 md:items-center ">
                            <div className=" h-120 md:w-7/12 border-2 border-indigo-600">
                            <div className="h-60 md:w-full ">
                                {hotel?.pictures.length < 1 ? (
                                    ...
                                    <Slide duration={3000} transitionDuration={400} prevArrow={<ArrowBackIosNewIcon className="text-blue-900" />} nextArrow={<ArrowForwardIosIcon className="text-blue-900" />}>
                            ...
                            <div className="md:w-7/12 mx-4 md:my-6 mb-6">
                                <div className="flex justify-between">
                                    ...
                                    <a href="#rooms" className="bg-blue-500 hover:bg-gray-100 hover:text-blue-500 text-gray-50 p-3 rounded-lg">Reserve a room</a>
                                </div>
