            ...
            <div className="flex">
                ...
                <Fragment>
                    {isLoading ? <Loader /> : (
                        <Fragment>
                            {!hotel ? <NotFound /> : (
                                <div className="w-[80%] sm:w-[60%] md:w-[70%] mx-auto mt-3 bg-yellow-300 ">
                                    <div className="flex flex-col md:flex-row gap-6 md:gap-4 justify-between ">
                                        <div className="flex gap-4">
                                            <Button onClick={() => navigate('/admin/hotels')}  className="bg-blue-500 hover:bg-gray-100 hover:text-blue-500"  ><ArrowBackIosNewIcon fontSize="small" className="mr-2" />Back</Button>
                                            <Button onClick={() => navigate(`/admin/hotel/${id}/room/new`)}  className=" bg-blue-500 hover:bg-gray-100 hover:text-blue-500"><WeekendIcon fontSize="small" className="mr-2" />Add Room</Button>
                                        </div>
                                        <div>
                                            <div className="flex gap-4">
