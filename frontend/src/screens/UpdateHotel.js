    ...
    return (
        <Fragment>
            ...
            <div className="flex">
                <SideBar />
                {isLoading ? <Loader /> : (
                    <div className="px-4 md:px-10 lg:px-20 xl:px-48 mx-auto bg-pink-200">
                        <h2 className="text-2xl font-medium text-center my-8">Update Hotel</h2>
                        <form className="flex flex-col gap-4" onSubmit={(e) => handleSubmit(e)}>
                            <div className="border border-solid border-gray-900 py-3 px-5 rounded">
                            ...
                            <FormControl className="md:w-[25rem] w-60 sm:w-80">
                                <InputLabel id="demo-multiple-checkbox-label" className="!text-gray-900 ">Specifications</InputLabel>
                                <CustomSelect
                            ...
                            <textarea required={true} placeholder="Hotel Description" rows={4} value={description} onChange={(e) => setDescription(e.target.value)} className="border border-solid border-gray-900 py-3 px-5 rounded resize-none focus:outline-none bg-transparent" />
                            <Button variant="contained" type="submit" className="bg-blue-500   !py-4">Update</Button>
                        </form>
                    </div >
                )}
            </div >
