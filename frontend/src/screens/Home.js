...
const Home = () => {
    ...
    return (
        <Fragment>
            <Meta title="LikhithHotel Booking Application" />
            <div className="mx-auto px-4 md:px-10 lg:px-20 xl:px-48  bg-pink-100">
                <h1 className="text-3xl text-grey-400">FILTER BY PLACE</h1>
                <div className="flex flex-col md:flex-row gap-4 mt-4 mb-6">
                    <div onClick={() => setIsSearchOpen(!isSearchOpen)} className=" md:w-4/12 h-16 rounded border transition duration-200 cursor-pointer border-gray-900 flex items-center px-6 gap-4 hover:border-blue-600 hover:bg-slate-100 bg-blue-200" >
                    ...
                    <div open={isDateOpen} onClick={() => setIsDateOpen(!isDateOpen)} className="md:w-4/12 h-16 rounded border transition duration-200 cursor-pointer border-gray-900 flex items-center px-6 gap-4  hover:bg-slate-100 bg-blue-200">
                    ...
                    <div onClick={() => setIsPersonOpen(!isPersonOpen)} className="md:w-4/12 h-16 rounded border transition duration-200 cursor-pointer border-gray-900 flex items-center px-6 gap-4  hover:bg-slate-100 bg-blue-200 ">
                    ...
                    <div className="flex justify-center mt-3 md:mt-0 items-center">
                        <button color="error" disabled={keyword.length < 1} variant="contained" className=" bg-blue-500 rounded font-medium hover:bg-green-600 disabled:bg-red-400 w-72 !text-orange-50 md:w-24 lg:w-32 md:h-full h-12 text-inherit"
