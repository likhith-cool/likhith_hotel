...
const Account = () => {
    ...
    return (
        <Fragment>
            ...
            <div className="mx-auto px-4 md:px-10 lg:px-20 xl:px-48 flex flex-col md:flex-row justify-between bg-fuchsia-300 pb-6 h-[calc(100vh-115px)] ">
                <div className="w-8/12 h-full mx-auto mb-6  border border-solid border-gray-600 bg-indigo-100 rounded flex flex-col">
                    ...
                    <hr className="mt-3 border-b border-dashed border-gray-600 mx-2" />
